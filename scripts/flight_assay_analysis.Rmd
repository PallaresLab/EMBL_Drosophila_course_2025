...
If you prefer other IDEs or base R console, you can copy-paste commands from the code blocks in `flight_assay_analysis.pdf` from <https://github.com/PallaresLab/EMBL_Drosophila_course_2025/blob/main/protocols/flight_assay_analysis.pdf> or `flight_assay_analysis.html` from <https://github.com/PallaresLab/EMBL_Drosophila_course_2025/blob/main/protocols/flight_assay_analysis.html>.
...
If you do not have `car` installed, you can run Brown-Forsythe test manually.
Compute absolute deviance from median for each sex manually, and run ANOVA.
